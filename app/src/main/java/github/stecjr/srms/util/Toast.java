...
public class Toast {
    ...
    public static void errorMessage(Context context, String message, int length) {
        ...
        toastLayout.setBackgroundTintList(context.getColorStateList(R.color.error));
        toastImage.setImageDrawable(AppCompatResources.getDrawable(context, R.drawable.eye_hide));
        toastText.setTextColor(context.getColor(R.color.errorContainer));
