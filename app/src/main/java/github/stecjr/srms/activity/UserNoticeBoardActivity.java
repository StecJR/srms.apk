...
import github.stecjr.srms.adapter.OptionSelectorAdapter;
        ...
        deleteButton.setOnClickListener(v -> {
            ...
            switch ((int) optionSpinner.getSelectedItemId()) {
                case -1:
                    ...
                    return;
                case 0:
                    deletedNotice = database.deleteLastNotice();
                    optionSpinner.setSelection(0);
                    isDismissed = false;
                    break;
                case 1:
                    deletedNotice = database.deleteNoticeOlderThan(6);
                    break;
                case 2:
                    deletedNotice = database.deleteNoticeOlderThan(12);
                    break;
                case 3:
                    deletedNotice = database.deleteNoticeOlderThan(24);
                    break;
                case 4:
                    deletedNotice = database.deleteNoticeOlderThan(36);
                    break;
                default:
            ...
            Toast.generalSuccess(this, deletedNotice + "  Notices deleted");
