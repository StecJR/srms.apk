package github.stecjr.srms.database;
...
import github.stecjr.srms.model.CourseInfo;
...
import github.stecjr.srms.model.Notice;
import github.stecjr.srms.model.PendingFaculty;
import github.stecjr.srms.model.PendingGuardian;
import github.stecjr.srms.model.PendingStudent;
import github.stecjr.srms.model.PendingVerifications;
import github.stecjr.srms.model.Results;
import github.stecjr.srms.model.ResultsSummary;
...
import github.stecjr.srms.util.Sha256;
...
public class Database extends SQLiteOpenHelper {
    ...
    private static final ArrayList<AccountType> accountTypes = null;
    ...
    public int deleteLastNotice() {
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                ...
                deletedRows = db.delete("notice_board", "noticeId = " + lastId, null);
            }
        } catch (Exception e) {
    ...
    public int deleteNoticeOlderThan(int month) {
        SQLiteDatabase db = null;
        int deletedRows = -1;
        try {
            ...
            db = this.getWritableDatabase();
            deletedRows = db.delete("notice_board", "createdAt < date(?)", threshold);
        } catch (Exception e) {
